...
const SETUP_CONFIG: Record<SetupType, { label: string; color: string }> = {
  ...
  EMA20_PULLBACK: { label: 'EMA20 PB', color: 'bg-setup-pullback/15 text-setup-pullback border-setup-pullback/25' },
  MA_RALLY_FAILURE: { label: 'MA Fail', color: 'bg-setup-fail/15 text-setup-fail border-setup-fail/25' },
  EMA200_KEY_LEVEL: { label: 'EMA200', color: 'bg-setup-pullback/15 text-setup-pullback border-setup-pullback/25' },
