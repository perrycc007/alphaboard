...
function readManifest(version) {
    ...
    if (!fs.existsSync(manifestPath)) {
        throw new common_1.NotFoundException(`Manifest not found for version ${version}`);
    }
    return JSON.parse(fs.readFileSync(manifestPath, 'utf-8'));
}
function getNextUnlabeled(version, forTelegram = false) {
    const manifest = readManifest(version);
    const labels = readLabels(version);
    const labeled = new Set(labels.map((l) => l.chart_id));
    return (manifest.find((m) => !labeled.has(m.chart_id) && (!forTelegram || !shouldIgnoreForTelegram(m))) ?? null);
}
async function telegramApi(method, init) {
    ...
    if (!res.ok) {
        ...
        throw new common_1.BadRequestException(`Telegram API ${method} failed: ${text}`);
    }
    return res.json();
}
...
async function sendTelegramChart(chatId, version, entry) {
    ...
    if (!imagePath.startsWith(artifactsRoot) || !htmlPath.startsWith(artifactsRoot)) {
        throw new common_1.NotFoundException('Invalid chart path');
    }
    ...
    throw new common_1.NotFoundException(`Chart files not found. Missing PNG: ${pngChartPath} and HTML: ${entry.chart_path}`);
}
let LabelController = class LabelController {
    ...
    async sendTelegramNext(body) {
        const version = body.version ?? 'v1';
        if (!body.chatId)
            throw new common_1.BadRequestException('chatId is required');
    ...
    async setTelegramWebhook(body) {
        if (!body.webhookUrl) {
            throw new common_1.BadRequestException('webhookUrl is required');
        }
    ...
    async telegramWebhook(update, secretHeader) {
        const expectedSecret = process.env.TELEGRAM_WEBHOOK_SECRET;
        if (expectedSecret && secretHeader !== expectedSecret) {
            throw new common_1.BadRequestException('Invalid Telegram webhook secret');
        }
        try {
            await (0, file_log_util_1.appendJsonLog)('telegram-inbound.json', {
    ...
    getStats(version) {
        ...
        for (const item of manifest) {
            ...
            if (!byType[t])
                byType[t] = { total: 0, yes: 0, no: 0, wrong_type: 0, unsure: 0 };
            byType[t].total++;
...
__decorate([
    (0, common_1.Get)('manifest/:version'),
    __param(0, (0, common_1.Param)('version')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], LabelController.prototype, "getManifest", null);
__decorate([
    (0, common_1.Get)('labels/:version'),
    __param(0, (0, common_1.Param)('version')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, common_1.Post)('labels/:version'),
    __param(0, (0, common_1.Param)('version')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], LabelController.prototype, "saveLabel", null);
__decorate([
    (0, common_1.Post)('telegram/send-next'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LabelController.prototype, "sendTelegramNext", null);
__decorate([
    (0, common_1.Post)('telegram/set-webhook'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], LabelController.prototype, "setTelegramWebhook", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], LabelController.prototype, "telegramWebhook", null);
__decorate([
    (0, common_1.Get)('image/:version/*'),
    __param(0, (0, common_1.Param)('version')),
    ...
    __metadata("design:returntype", void 0)
], LabelController.prototype, "serveImage", null);
__decorate([
    (0, common_1.Get)('stats/:version'),
    __param(0, (0, common_1.Param)('version')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], LabelController.prototype, "getStats", null);
